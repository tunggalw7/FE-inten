...
@Component({
  selector: "list-sekolah",
  templateUrl: "./list-sekolah.component.html",
  styleUrls: ["./list-sekolah.component.scss"],
})
export class ListSekolahComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditSekolahComponent, { closeOnBackdropClick: false })
