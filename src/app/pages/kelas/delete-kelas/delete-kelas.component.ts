...
@Component({
  selector: 'delete-kelas',
  styleUrls: ['./delete-kelas.component.scss'],
  templateUrl: './delete-kelas.component.html',
})
export class DeleteKelasComponent implements OnDestroy, OnInit {
    dataForm: any;
    submitLoading: Boolean = false;
    baseService = "core/kelas";

    constructor(
      protected ref: NbDialogRef<DeleteKelasComponent>,
