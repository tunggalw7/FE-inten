...
import { AddEditKelasComponent } from "../add-edit-kelas/add-edit-kelas.component";
import { DeleteKelasComponent } from "../delete-kelas/delete-kelas.component";

@Component({
  selector: "list-kelas",
  templateUrl: "./list-kelas.component.html",
  styleUrls: ["./list-kelas.component.scss"],
})
export class ListKelasComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditKelasComponent, { closeOnBackdropClick: false })
