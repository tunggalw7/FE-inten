...
@Component({
  selector: "list-mata-pelajaran",
  templateUrl: "./list-mata-pelajaran.component.html",
  styleUrls: ["./list-mata-pelajaran.component.scss"],
})
export class ListMataPelajaranComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditMataPelajaranComponent, { closeOnBackdropClick: false })
  ...
  editUser(data) {
    this.dialogService
      .open(AddEditMataPelajaranComponent, {
  ...
  deleteUser(data) {
    this.dialogService
      .open(DeleteMataPelajaranComponent, {
        closeOnBackdropClick: false,
        context: {
          dataForm: data,
        },
