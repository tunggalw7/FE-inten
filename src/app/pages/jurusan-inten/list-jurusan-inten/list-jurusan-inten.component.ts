...
@Component({
  selector: "list-jurusan-inten",
  templateUrl: "./list-jurusan-inten.component.html",
  styleUrls: ["./list-jurusan-inten.component.scss"],
})
export class ListJurusanIntenComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditJurusanIntenComponent, { closeOnBackdropClick: false })
  ...
  editUser(data) {
    this.dialogService
      .open(AddEditJurusanIntenComponent, {
  ...
  deleteUser(data) {
    this.dialogService
      .open(DeleteJurusanIntenComponent, {
        closeOnBackdropClick: false,
        context: {
          dataForm: data,
        },
