...
@Component({
  selector: "list-soal_to",
  templateUrl: "./list-soal_to.component.html",
  styleUrls: ["./list-soal_to.component.scss"],
})
export class ListSoalToComponent implements OnInit {
  actionSelect: String;
  ...
  addSoal() {
    this.dialogService
    .open(AddEditSoalToComponent, { closeOnBackdropClick: false })
