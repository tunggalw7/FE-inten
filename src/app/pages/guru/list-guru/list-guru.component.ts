...
import { AddEditGuruComponent } from "../add-edit-guru/add-edit-guru.component";
import { DeleteGuruComponent } from "../delete-guru/delete-guru.component";

@Component({
  selector: "list-guru",
  templateUrl: "./list-guru.component.html",
  styleUrls: ["./list-guru.component.scss"],
})
export class ListGuruComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditGuruComponent, { closeOnBackdropClick: false })
