...
@Component({
  selector: 'add-edit-uang-biaya',
  styleUrls: ['./add-edit-uang-biaya.component.scss'],
  templateUrl: './add-edit-uang-biaya.component.html',
})

export class AddEditUangBiayaComponent implements OnDestroy, OnInit {
  ID: any;
  ...
  constructor(
    ...
    this.UangBiayaForm = this.formBuilder.group({
      tanggal_terima: ['', Validators.required],
      tanggal_transfer: ['', Validators.required],
      ...
      total_sisa_biaya_kurang: ['', Validators.required],
      keterangan: ['', Validators.required],
      type_pembayaran: ['', Validators.required],
      keterangan_pembayaran: ['', Validators.required],
      cicilan: ['', Validators.required],
      total_bayar: ['', Validators.required],
      bayar_nit: ['', Validators.required],
      biaya_kurang: ['', Validators.required],
      kode_kwitansi: ['', Validators.required],
    });
    ...
    this.route.queryParams.subscribe(params => {
      if (params.id) {
        ...
        this.type = 'Edit';
        this.ID = params.id;
        this.getDetail(params.nis);
        this.getData(params.id);   
        this.getListBayarSiswa(params.nis);
        this.UangBiayaForm.controls.kode_kwitansi.disable();
      } else {   
    ...
    this.masterService.getByID(this.siswaService, id).subscribe((result) => {
      ...
      if (data) {
        this.UangBiayaForm.patchValue({
          ...
          'tanggal_masuk' : moment(data.tanggal_masuk).format("LL"),
          'tanggal_transfer' : moment(data.tanggal_transfer).format("YYYY-MM-DD"),
